...
//! Structured JSON logger for Zig components.
...
pub const Logger = struct {
    ...
    pub fn setComponent(logger: *Logger, component: []const u8) void {
...
var global_logger = Logger.init("cocovisor");

pub fn getLogger() *Logger {
    return &global_logger;
}

pub fn setComponent(component: []const u8) void {
    global_logger.component = component;
}

pub fn log(level: Level, msg: []const u8) void {
    global_logger.log(level, msg, null, null);
}
