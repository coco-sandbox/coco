...
// Package handlers provides HTTP handlers for the Coco API.
package handlers
...
// HandlerFunc returns http.HandlerFunc for sandbox operations
func (h *SandboxHandler) HandlerFunc(op string) http.HandlerFunc {
	switch op {
	case "create":
